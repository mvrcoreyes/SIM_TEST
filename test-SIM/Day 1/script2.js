// Documento de calibración -- Parte 2
// INPUT DE EJEMPLO
// let input = `
// two1nine
// eightwothree
...
let input2 = `fivethreeonezblqnsfk1
two74119onebtqgnine
jrjh5vsrxbhsfour3
...
// Se utiliza un bucle forEach para iterar sobre cada línea del texto, donde cada línea se representa con la variable line.
// este código parece buscar el primer y el último número en cada línea,
// utilizando indexOf y lastIndexOf respectivamente, y luego suma estos números para cada línea.
target.forEach((line) => {
  findex = line.length;
  lindex = -1;
...
console.log(`PARTE 2`);
console.log(`La suma de todos los valores de calibración es:`, sum);
